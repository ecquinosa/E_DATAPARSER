...
Public Class RptCarrier_PLAY
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClientDLL_UBP_DAO.RptCarrier_PLAY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCarrier_PLAY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCarrier_PLAY = New RptCarrier_PLAY()
        rpt.Site = Me.Site
        Return rpt
    End Function
