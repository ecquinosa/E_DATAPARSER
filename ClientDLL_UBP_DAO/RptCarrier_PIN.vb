...
Public Class RptCarrier_PIN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClientDLL_UBP_DAO.RptCarrier_PIN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCarrier_PIN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCarrier_PIN = New RptCarrier_PIN()
        rpt.Site = Me.Site
        Return rpt
    End Function
